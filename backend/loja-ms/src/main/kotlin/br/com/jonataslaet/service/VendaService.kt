...
import br.com.jonataslaet.producer.VendaProducer
...
class VendaService(
    ...
    fun realizarVenda(vendaInput: VendaInput) : VendaOutput{
    ...
    fun confirmarVenda(vendaOutput: VendaOutput){
        var vendaJSON = objectMapper.writeValueAsString(vendaOutput)
